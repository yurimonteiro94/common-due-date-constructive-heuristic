...
$tarefas = @(
    [PSCustomObject]@{Arquivo="sch1000.txt"; H="4"; Instancia="1"; Sufixo="1000_04"; Peso=110},
    [PSCustomObject]@{Arquivo="sch1000.txt"; H="2"; Instancia="1"; Sufixo="1000_02"; Peso=100},
    [PSCustomObject]@{Arquivo="sch500.txt"; H="4"; Instancia="1"; Sufixo="500_04"; Peso=70},
    [PSCustomObject]@{Arquivo="sch500.txt"; H="2"; Instancia="1"; Sufixo="500_02"; Peso=65},
...
function Iniciar-Tarefa {
    ...
    $processo = Start-Process `
        -FilePath ".\testes\experimento_busca_local_inversao.exe" `
